namespace ToolTipGosterimnstration
{
   partial class ToolTipGosterimnstrationForm
   {
      /// <summary>
      ...
      private void InitializeComponent()
      {
         ...
         this.Name = "ToolTipGosterimnstrationForm";
         this.Text = "ToolTip Gosterimnstration";

namespace GroupBoxPanelOrnek
{
   partial class GroupBoxPanelOrnekForm
   {
      /// <summary>
      ...
      private void InitializeComponent()
      {
         ...
         this.Name = "GroupBoxPanelOrnekForm";
         this.Text = "GroupBox and Panel Ornek";

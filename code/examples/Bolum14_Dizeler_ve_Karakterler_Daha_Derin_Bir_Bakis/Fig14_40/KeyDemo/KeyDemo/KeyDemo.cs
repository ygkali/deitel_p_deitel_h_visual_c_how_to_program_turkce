...
namespace KeyGosterim
{
   ...
   public partial class KeyGosterim : Form
   {
      // default constructor
      public KeyGosterim()
      {
      ...
      private void KeyGosterim_KeyPress(object sender, KeyPressEventArgs e)
      {
         charLabel.Text = $"Key pressed: {e.KeyChar}";
      }

      // display modifier keys, key code, key data and key value
      private void KeyGosterim_KeyDown(object sender, KeyEventArgs e)
      {
         keyInfoLabel.Text =
            $"Alt: {(e.Alt ? "Yes" : "No")}\n" +
      ...
      private void KeyGosterim_KeyUp(object sender, KeyEventArgs e)
      {
         charLabel.Text = "";
         keyInfoLabel.Text = "";
      }

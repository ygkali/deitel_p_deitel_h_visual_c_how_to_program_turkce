namespace KeyGosterim
{
   partial class KeyGosterim
   {
      /// <summary>
      ...
      private void InitializeComponent()
      {
         ...
         this.Name = "KeyGosterim";
         this.Text = "Key Gosterim";
         this.KeyDown += new System.Windows.Forms.KeyEventHandler(this.KeyGosterim_KeyDown);
         this.KeyPress += new System.Windows.Forms.KeyPressEventHandler(this.KeyGosterim_KeyPress);
         this.KeyUp += new System.Windows.Forms.KeyEventHandler(this.KeyGosterim_KeyUp);

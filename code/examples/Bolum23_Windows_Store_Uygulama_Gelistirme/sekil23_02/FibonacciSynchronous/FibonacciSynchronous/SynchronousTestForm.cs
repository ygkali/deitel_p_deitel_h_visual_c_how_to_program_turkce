// Sekil 23.2: SynchronousTestForm.cs
...
namespace FibonacciSynchronous
{
   public partial class SynchronousTestForm : Form
   {
      ...
      private void startButton_Click(object sender, EventArgs e)
      {
         ...
         outputTextBox.UygulamaendText($"Fibonacci(46) = {result1}\r\n");
         ...
         outputTextBox.UygulamaendText("Calculating Fibonacci(45)\r\n");
         outputTextBox.Refresh(); // force outputTextBox to repaint
         ...
         outputTextBox.UygulamaendText($"Fibonacci(45) = {result2}\r\n");

// Sekil 16.12: StringBuilderUygulamaendFormat.cs
// StringBuilder's UygulamaendFormat method
using System;
using System.Text;

class StringBuilderUygulamaendFormat
{
   static void Main()
   {
      ...
      buffer.UygulamaendFormat(string1, objectArray);
      ...
      // append to buffer formatted string with argument
      buffer.UygulamaendFormat(string2, 5);
